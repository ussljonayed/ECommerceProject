...
namespace ECommerceProject.Controllers
{
    public class ProductModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ModelName")] ProductModel productModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ModelName")] ProductModel productModel)
        {
