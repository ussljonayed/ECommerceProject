...
namespace ECommerceProject.Controllers
{
    public class ProductImagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ImageName,ImageCode,ImageSize,ImageExtension,ProductId")] ProductImage productImage)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Product, "Id", "ProductCode", productImage.ProductId);
            return View(productImage);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ImageName,ImageCode,ImageSize,ImageExtension,ProductId")] ProductImage productImage)
        {
